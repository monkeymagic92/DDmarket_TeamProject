	...
	<div id="headerWrap">
            <header id="header">
                <div id="header-title">
                    ...
                    <form id="search-wrap" action="/index/search" method="post" onsubmit="return chkSearch()">
                        <input type="text" id="header-search-text" placeholder="상품명, 지역명 검색" name="searchNm" value="${searchNm}">
